...
Because the Tailwind compiler runs as part of the Thebe build pipeline, your styles are instantly rebuilt whenever you change a `.trs` component during `thebe dev`.
