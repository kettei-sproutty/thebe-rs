...
pub fn generate_route(
    ...
    writeln!(source, "const __TEMPLATE: &str = {template_literal};").expect("infallible");
    writeln!(source, "const __CLIENT_RUNTIME: &str = {runtime_literal};").expect("infallible");
    write!(source, "const __CLIENT_SCRIPT: &str = {client_script_literal};\n\n").expect("infallible");
    source.push_str(
...
pub fn generate_main(routes: &[RouteEntry]) -> String {
    ...
    for route in routes {
        writeln!(source, "    pub mod {};", route.mod_name).expect("infallible");
    }
    source.push_str("}\n\n");
    ...
    for route in routes {
        writeln!(source, "        .merge(routes::{}::router())", route.mod_name)
            .expect("infallible");
    }
    source.push_str("    ;\n\n");
    source.push_str(
